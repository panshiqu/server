...
func (c *networkClient) Connect(ctx context.Context, opts ...grpc.CallOption) (Network_ConnectClient, error) {
	stream, err := c.cc.NewStream(ctx, &Network_ServiceDesc.Streams[0], "/pb.Network/Connect", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *networkConnectClient) Send(m *Msg) error {
	return x.ClientStream.SendMsg(m)
}

func (x *networkConnectClient) Recv() (*Msg, error) {
	m := new(Msg)
...
func (x *networkConnectServer) Send(m *Msg) error {
	return x.ServerStream.SendMsg(m)
}

func (x *networkConnectServer) Recv() (*Msg, error) {
	m := new(Msg)
